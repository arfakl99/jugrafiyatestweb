...
const Model = () => {
    ...
    // GLTFLoader,
    // "https://jugrafiya-meta.s3.eu-north-1.amazonaws.com/jugrafiya-website/public/scene.bin,https://jugrafiya-meta.s3.eu-north-1.amazonaws.com/jugrafiya-website/public/scene.gltf"
    // );

    // const binData = useLoader(
    // GLTFLoader,
    // "https://jugrafiya-meta.s3.eu-north-1.amazonaws.com/jugrafiya-website/public/scene.bin"
    // );

    // const gltfData = useLoader(
    // GLTFLoader,
    // "https://jugrafiya-meta.s3.eu-north-1.amazonaws.com/jugrafiya-website/public/scene.gltf"
    // );
...
export default function Home() {
    ...
    // form
    const notify = () => toast("Thank you for contacting! We'll get back to you soon");
    ...
    return (
        <div>
            ...
            <section className="sec1 bg-[#FAF9F6] px-[10%] flex globesec h-[90vh] justify-center items-center text-center">
                <div className="flex flex-col w-[50%] globtext">
                    <h1 className="heading text-left text-4xl leading-normal mb-2 font-bold text-gray-600">
                        GIS Solutions & Services
                    </h1>
                    <p className="para text-left mt-10 text-xl md:text-lg text-gray-600">
                    ...
                    <ol className="pl-4 para text-left mt-8 text-xl md:text-lg text-gray-600 list-disc">
            ...
            <section className="sec2 services bg-white pt-16 pb-5 px-[10%]">
                ...
                <div className="service gap-14 container flex justify-center  items-center  mt-7 w-auto">
                    <div className="appear imgcard hover:shadow-lg img-shadow flex flex-col text-[#565656] border-2 rounded-[20px]  w-[22%] overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                        <div>
                            <Image src={desktop}
                    ...
                    <div className="imgcard hover:shadow-lg border-2 flex flex-col text-[#565656] rounded-[20px] w-[22%] overflow-hidden" data-aos="fade-up" data-aos-delay="500">
                        <div>
                            <Image src={consultancy}
                    ...
                    <div className="imgcard hover:shadow-lg border-2  flex flex-col  text-[#565656]  rounded-[20px]  w-[22%] overflow-hidden " data-aos="fade-up" data-aos-delay="900">
                        <div>
                            <Image src={appdev}
                    ...
                    <div className="imgcard hover:shadow-lg border-2   flex flex-col text-[#565656]  rounded-[20px]  w-[22%] overflow-hidden" data-aos="fade-up" data-aos-delay="1300">
                        <div>
                ...
                <div className="service gap-14  container flex items-center justify-center mt-12 pb-16 w-full">
                    <div className="imgcard hover:shadow-lg border-2 flex flex-col text-[#565656]  rounded-[20px]  w-[22%] overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                        <div>
                            <Image src={analysis}
            ...
            <section className="bg-[#FAF9F6] sec3 px-[10%] flex flex-col flex-wrap py-10">
                ...
                <div className="flex flex-col ">
                    ...
                    <div className="techdiv1 flex space-x-36  items-center justify-center mt-6">
                        <div className=" flex flex-col justify-items-center items-center justify-center gap-1" data-aos="fade-right">
                            <Image src={geoserver}
                        ...
                        <div className=" flex flex-col justify-items-center items-center justify-center gap-2" data-aos="fade-right" data-aos-delay="100">
                            <Image src={leaflet}
                        ...
                        <div className=" flex flex-col justify-items-center items-center justify-center gap-2" data-aos="fade-right" data-aos-delay="200">
                            <Image src={mapbox}
                        ...
                        <div className="imgset flex flex-col justify-items-center items-center justify-center gap-2" data-aos="fade-right" data-aos-delay="300">
                            <Image src={openlayer}
                ...
                <div className="techdiv2 flex flex-col  py-8">
                    ...
                    <div className="techdiv2 flex space-x-36 justify-center mt-8">
                        <div className=" flex flex-col justify-items-center items-center justify-center gap-2" data-aos="fade-right">
                            <Image src={react}
                        ...
                        <div className="imgset mobiledev flex flex-col justify-items-center items-center justify-center gap-2" data-aos="fade-right" data-aos-delay="100">
                            <Image src={nextjs}
                        ...
                        <div className="flex flex-col justify-items-center items-center justify-center gap-2" data-aos="fade-right" data-aos-delay="300">
                        ...
                        <div className=" imgset flex flex-col justify-items-center items-center justify-center gap-2" data-aos="fade-right" data-aos-delay="400">
                    ...
                    <div className="flex mt-6">
                        <div className="flex w-[65%] flex-wrap flex-col">
                            ...
                            <div className="flex items-center justify-center gap-20 mt-10">
                                <div className="flex flex-col items-center justify-start gap-2" data-aos="fade-right">
                                    <Image src={quickcapture}
                                ...
                                <div className="flex flex-col items-center justify-center gap-2" data-aos="fade-right" data-aos-delay="100">
                                    <Image src={storymap}
                                ...
                                <div className="flex flex-col  items-center justify-center gap-2" data-aos="fade-right" data-aos-delay="200">
                                    <Image src={survey}
                        ...
                        <div className=" grow flex">
                            <div className=" flex flex-col items-center justify-center gap-2 " data-aos="fade-right" data-aos-delay="500">
                                <Image src={developer}
                            ...
                            <div className="flex items-center justify-center ml-5 mr-5 border-gray-300 border-r-2 border-t-2 border-b-2 w-4" data-aos="fade-right" data-aos-delay="600"></div>
                            <div className="flex flex-col justify-center  gap-3 text-gray-600" data-aos="fade-right" data-aos-delay="700">
            ...
            <section className="sec4 services bg-[#FAF9F6] pt-20  pb-5 px-[10%]">
                ...
                <div className="service container flex  items-center justify-between mt-3 w-auto">
                    <div className="domaincard hover:shadow-lg border-2 flex flex-col text-[#565656]  rounded-[20px] " data-aos="fade-up" data-aos-delay="100">
                        <div>
                            <Image src={utility}
                    ...
                    <div className="domaincard hover:shadow-lg border-2  flex flex-col text-[#565656]  rounded-[20px]   " data-aos="fade-up" data-aos-delay="500">
                        <div>
                    ...
                    <div className="domaincard hover:shadow-lg border-2   flex flex-col text-[#565656]  rounded-[20px] " data-aos="fade-up" data-aos-delay="900">
                        <div>
                            <Image src={oilgas}
                                width={460}
                    ...
                    <div className="formsec flex justify-items-center ">
                        ...
                        <div className="setform w-[50%] ">
                            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md  justify-start contact_mobile">
                                <form method="POST" action="https://www.formbackend.com/forms/0f3030d8719b702f/test" className="space-y-8 mt-10"
